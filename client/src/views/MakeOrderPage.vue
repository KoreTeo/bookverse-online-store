    ...
    <div className="main_order">
        <div className="order__take_order">
            ...
            <div className="take_order__adress">
                ...
                <input className="take_order__input_adress" id="Location" placeholder="г. Красноярск, Красноярский край, Россия">
                    ...
                    <ul className="delivery_type__list">
                        <li className="delivery_type__list_el">
                            <div className="delivery_type__list_el_info">
                                <input value="self" name="del_type" type="radio" checked="true" className="delivery_type__list_radio">
                        ...
                        <li className="delivery_type__list_el">
                            <div className="delivery_type__list_el_info">
                                <input value="courier" name="del_type" type="radio"  className="delivery_type__list_radio">
                        ...
                        <li className="delivery_type__list_el">
                            <div className="delivery_type__list_el_info">
                                <input value="rusmail" name="del_type" type="radio"  className="delivery_type__list_radio">
                ...
                <div className="take_order__pay_type">
                    ...
                    <ul className="delivery_type__list">
                        <li className="pay_type__list_el">
                            <input value="card" name="pay_type" type="radio" checked="true" className="delivery_type__list_radio">
                ...
                <div className="reciver__parts">
                    <ul className="reciver__list">
                        ...
                        <li className="reciver__list_el">
                            ...
                            <input className="reciver__list_el_input" id="Email" type="email" placeholder="ro.rub@mail.ru">
                        </li>
                        <li className="reciver__list_el">
                    ...
                    <div className="reciver__comments">
                        ...
                        <textarea className="reciver__textarea"id="Comments" placeholder="Калитка открывается с кодом 88005553535."></textarea>
                    </div>
                </div>
            </div>
        </div>
